...
I use the [Hugo academic template](https://github.com/wowchemy/starter-hugo-academic) along with Rstudio's [Blogdown](https://github.com/rstudio/blogdown) package to generate and deploy this website to [github pages](https://pages.github.com/). I use this setup to generate blog posts (via [Rmarkdown](https://rmarkdown.rstudio.com/)) that render $\LaTeX$ math and output from R code. 
