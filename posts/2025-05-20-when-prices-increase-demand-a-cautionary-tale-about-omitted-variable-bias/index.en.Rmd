...
In this post, I provide a fictional and real example of cases where the omitted variables bias can lead to incorrect learnings. I leverage the [rust package](https://github.com/jModeler/marketing-iv-methods-examination) I created to provide values in the fictional example.
